    ...
    return (
        <div className=' sub_card1 overflow-hidden pt-9 w-80 '>
            <div className='relative flex flex-col pl-6 pr-6 z-30 '>
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-[7.39px] z-[0] ">
                    <div className="relative tracking-[-1px] leading-[30.4px] inline-block [text-shadow:0px_0px_1px_rgba(0,_0,_0,_0.01)] text-purple-500 text-xl max-w-[304px] pl-4">
                        {text}
                    </div>
                ...
                <div className='absolute right-6 top-5'>
                    <div><p className='text-flow-com-hackathon-1903x885-default-nero-30'> [ <span>1</span> ]</p></div>
                </div>
